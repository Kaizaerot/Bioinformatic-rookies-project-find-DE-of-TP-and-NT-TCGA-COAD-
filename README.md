RESULTS: Plotting with volcano graph. Showing results of DE Tumor Primary and Normal Tumor with top 5 and 10 upregulate/downregulate using FDR and P-Value in TCGA-COAD (The data is from TCGABiolink). 
